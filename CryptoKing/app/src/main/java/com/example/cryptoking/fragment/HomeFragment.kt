...
import com.example.cryptoking.adapter.TopLossGainPagerAdapter
import com.example.cryptoking.adapter.TopMarketAdapter
import com.example.cryptoking.apis.ApiInterface
import com.example.cryptoking.apis.ApiUtilities
import com.example.cryptoking.databinding.FragmentHomeBinding
...
class HomeFragment : Fragment() {
    ...
    private fun getTopCurrencyList() {
        lifecycleScope.launch(Dispatchers.IO){
            ...
            Log.d("ALOK","getTopCurrencyList:${res.body()!!.data.cryptoCurrencyList}")
        }
    }
