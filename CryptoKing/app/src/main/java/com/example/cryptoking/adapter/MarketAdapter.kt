...
import com.example.cryptoking.databinding.CurrencyItemLayoutBinding
import com.example.cryptoking.fragment.*
    ...
    override fun onBindViewHolder(holder: MarketViewHolder, position: Int) {
        ...
        holder.itemView.setOnClickListener {
            if (type == "home") {
                ...
                findNavController(it).navigate(
                    WishListFragmentDirections.actionWishListFragmentToDetailsFragment(item)
                )
            }
        }
